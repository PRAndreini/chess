...
def draw_game_state(win, gs: GameState, valid_moves: list, square_selected: tuple):
    """
...
def main():
    ...
    animated = False  ## Pretty obvious: set to "True" if you want animations, else "False".
